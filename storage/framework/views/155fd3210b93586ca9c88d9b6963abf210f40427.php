<?php $__env->startSection('content'); ?>
	...
	<form action="admin/sanpham/sua/<?php echo e($sanpham->id_sp); ?>" method="POST" enctype="multipart/form-data">
		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
			...
			<label >Giá:</label>
			<input class="form-control" type="number" name="gia"  value="<?php echo e($sanpham->gia); ?>" />
			</div><div class="form-group">
			<label >Ảnh</label>
			...
			<input type="number" class="form-control" name="soluong" value="<?php echo e($sanpham->so_luong_ton); ?>" />
			</div><div class="form-group">
			<label >Mới : </label>
