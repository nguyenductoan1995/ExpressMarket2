	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="breadcrumbs">
			<p>
				...
				<a href="{{route('loaisanpham',$sp->id_loai)}}">{{$typeProduct[0]->ten_loai}}</a>
				<i class="icons icon-right-dir"></i>{{$sp->ten_sp}}</p>
		</div>
	</div>
				...
				<div class="col-lg-8 col-md-8 col-sm-8 product-single-info full-size">
					...
					<table>
						...
						<tr>
							...
							<td>
								<span class="green">còn hàng</span> {{$sp->so_luong_ton}} items</td>
					...
					<span class="price">
						<del>{{ number_format($sp->gia + 100000,0)}} vnđ</del>{{ number_format($sp->gia,0)}} vnđ</span>
					...
					<div>
						...
						<div class="product">
							...
							<div class="product-image">
								<a href="{{route('chitietsanpham',$cl->id_sp)}}">
							...
							<div class="product-info">
								<h5>
									<a href="{{route('chitietsanpham',$cl->id_sp)}}">{{$cl->ten_sp}}</a>
								</h5>
							...
							<div class="product-actions">
								<span class="add-to-cart">
									<span class="action-wrapper" onclick="AddToCart({{$cl->id_sp}},{{Session('cart')->totalQty}})">
										<a>
							...
							@else
							<div class="product-actions">
								<span class="add-to-cart" onclick="AddToCart({{$cl->id_sp}},0)">
									<span class="action-wrapper">
										<a>
											<i class="icons icon-basket-2"> Thêm vào giỏ hàng</i>
											<span class="action-name">Add to cart</span>
				...
				<div class="owl-carousel" data-max-items="4">
					...
					<div>
						...
						<div class="product">
							...
							<div class="product-image">
								<a href="{{route('chitietsanpham',$hot->id_sp)}}">
							...
							<div class="product-info">
								<h5>
									<a href="{{route('chitietsanpham',$hot->id_sp)}}">{{$hot->ten_sp}}</a>
								</h5>
							...
							<div class="product-actions">
								<span class="add-to-cart">
									<span class="action-wrapper" onclick="AddToCart({{$hot->id_sp}},{{Session('cart')->totalQty}})">
										<a>
											<i class="icons icon-basket-2"> Thêm vào giỏ hàng</i>
											<span class="action-name">Add to cart</span>
										</a>
							...
							@else
							<div class="product-actions">
								<span class="add-to-cart" onclick="AddToCart({{$hot->id_sp}},0)">
									<span class="action-wrapper">
										<a>
											<i class="icons icon-basket-2"> Thêm vào giỏ hàng</i>
											<span class="action-name">Add to cart</span>
