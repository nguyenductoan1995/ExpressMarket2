									...
									<div>
										...
										<div class="product">
											...
											<div class="product-info">
												<h5><a href="{{route('chitietsanpham',$spt->id_sp)}}">{{$spt->ten_sp}}</a></h5>
                            ...
                            @foreach($SanPhamTim2 as $spt2)	
									...
									<div>
										...
										<div class="product">
											...
											<div class="product-image">
												<img src="source/img/products/{{$spt2->url_hinh}}" alt="Product1">
												<a href="products_page_v1.html" class="product-hover">
													<i class="icons icon-eye-1"></i> Xem nhanh
												</a>
											</div>
											...
											<div class="product-info">
												<h5><a href="{{route('chitietsanpham',$spt2->id_sp)}}">{{$spt2->ten_sp}}</a></h5>
